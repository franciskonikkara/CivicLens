  ...
  return (
    <main className="min-h-screen bg-cream">
      ...
      <div className="max-w-5xl mx-auto py-20 px-4 text-center">
        <p className="text-sm uppercase tracking-widest text-forest font-semibold mb-4">Coming Soon</p>
        ...
        <div className="inline-flex flex-col gap-2 text-left bg-white border border-stone-200 rounded-xl p-6 text-sm text-stone-600 max-w-sm w-full mb-10">
          {[
