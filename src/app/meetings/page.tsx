  ...
  return (
    <main className="min-h-screen bg-cream">
      ...
      <div className="max-w-5xl mx-auto py-20 px-4 text-center">
        ...
        <h1 className="text-5xl font-serif font-bold text-ink mb-6">Meeting Decoder</h1>
        <p className="text-stone-600 text-xl max-w-lg mx-auto mb-8">
          AI-transcribed council meetings with per-member vote breakdowns, timestamped video links,
