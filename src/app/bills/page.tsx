  ...
  return (
    <main className="min-h-screen bg-cream">
      ...
      <div className="max-w-5xl mx-auto py-20 px-4 text-center">
        ...
        <h1 className="text-5xl font-serif font-bold text-ink mb-6">Bill Explainer</h1>
        <p className="text-stone-600 text-xl max-w-lg mx-auto mb-8">
          Every ordinance and ballot measure decoded — what it does, who supports or opposes it, what
          it costs, and which council meetings produced it.
        </p>
